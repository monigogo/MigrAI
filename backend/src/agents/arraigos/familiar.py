...
async def agente_arraigo_familiar(state: dict) -> dict:
    ...
    rag    = buscar_contexto(pregunta, tramite="arraigo_familiar")
    ...
    prompt = ARRAIGO_FAMILIAR_PROMPT.format(
        bloque_cultural=bloque,
        especialidad="arraigo por circunstancias familiares",
        contexto_rag=rag,
    )
