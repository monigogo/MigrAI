...
const sinPapelesLinks: EmpleoLink[] = [
  ...
  { title: "Parroquias – Bolsa de trabajo", desc: "Parroquias que ofrecen bolsas de empleo y ayuda para encontrar trabajo.", url: "https://parroquiasantamariadeladehesa.es/bolsa-de-trabajo-2/", emoji: "⛪" },
];
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2 px-1">
          ...
          <h3 className="font-heading text-sm font-bold text-foreground">📄 Con papeles</h3>
        </div>
        <div className="space-y-3">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2 px-1">
          ...
          <h3 className="font-heading text-sm font-bold text-foreground">🙌 Sin papeles</h3>
        </div>
        <div className="space-y-3">
